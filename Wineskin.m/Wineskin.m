	...
	if (nonStandardRun)
	{
		...
		else if ([wssCommand isEqualToString:@"WSS-winetricks"])
		{
			...
			if ([winetricksCommand2 isEqualToString:@"list"]) //just getting a list of packages... X should NOT be running.
				[self systemCommand:[NSString stringWithFormat:@"export WINEDEBUG=%@;cd \"%@/../Wineskin.app/Contents/Resources\";export PATH=\"$PWD:%@/WineskinEngine.bundle/Wine/bin:%@/WineskinEngine.bundle/X11/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin\";export DISPLAY=%@;export WINEPREFIX=\"%@\";DYLD_FALLBACK_LIBRARY_PATH=\"%@/WineskinEngine.bundle/X11/lib:%@/WineskinEngine.bundle/Wine/lib:/usr/lib:/usr/libexec:/usr/lib/system:/usr/X11/lib:/usr/X11R6/lib\" winetricks %@ > \"%@\"",wineDebugLine,contentsFold,winePrefix,winePrefix,theDisplayNumber,winePrefix,winePrefix,winePrefix,winetrickCommandsList,wineLogFile]];
			else if ([winetricksCommand isEqualToString:@"list"])
				[self systemCommand:[NSString stringWithFormat:@"export WINEDEBUG=%@;cd \"%@/../Wineskin.app/Contents/Resources\";export PATH=\"$PWD:%@/WineskinEngine.bundle/Wine/bin:%@/WineskinEngine.bundle/X11/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin\";export DISPLAY=%@;export WINEPREFIX=\"%@\";DYLD_FALLBACK_LIBRARY_PATH=\"%@/WineskinEngine.bundle/X11/lib:%@/WineskinEngine.bundle/Wine/lib:/usr/lib:/usr/libexec:/usr/lib/system:/usr/X11/lib:/usr/X11R6/lib\" winetricks \"%@\" > \"%@\"",wineDebugLine,contentsFold,winePrefix,winePrefix,theDisplayNumber,winePrefix,winePrefix,winePrefix,winetricksCommand,wineLogFile]];
			else
				[self systemCommand:[NSString stringWithFormat:@"export WINEDEBUG=%@;cd \"%@/../Wineskin.app/Contents/Resources\";export PATH=\"$PWD:%@/WineskinEngine.bundle/Wine/bin:%@/WineskinEngine.bundle/X11/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin\";export DISPLAY=%@;export WINEPREFIX=\"%@\";DYLD_FALLBACK_LIBRARY_PATH=\"%@/WineskinEngine.bundle/X11/lib:%@/WineskinEngine.bundle/Wine/lib:/usr/lib:/usr/libexec:/usr/lib/system:/usr/X11/lib:/usr/X11R6/lib\" winetricks \"%@\" > \"%@\" 2>&1",wineDebugLine,contentsFold,winePrefix,winePrefix,theDisplayNumber,winePrefix,winePrefix,winePrefix,winetricksCommand,wineLogFile]];
